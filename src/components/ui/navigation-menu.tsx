...
const navigationMenuTriggerStyle = cva(
  "group inline-flex justify-center items-center data-active:bg-accent/50 data-[state=open]:bg-accent/50 hover:bg-accent focus:bg-accent disabled:opacity-50 px-4 py-2 rounded-md focus:outline-hidden w-max h-10 font-medium text-sm transition-colors hover:text-accent-foreground focus:text-accent-foreground disabled:pointer-events-none"
)
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDown
      className="top-px relative ml-1 w-3 h-3 group-data-[state=open]:rotate-180 transition duration-200"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
